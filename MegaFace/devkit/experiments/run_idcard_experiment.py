...
def main():
    ...
    parser.add_argument('-s', '--sizes', type=int, nargs='+',
                        help='(optional) Size(s) of feature list(s) to create. Default: 10 100 1000 10000 100000 996164')
    ...
    parser.set_defaults(model=MODEL, num_sets=1, sizes=[10, 100, 1000, 10000, 100000, 996164],
